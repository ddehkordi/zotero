...
return null},yd=!1;if(H.querySelectorAll)try{var zd=H.querySelectorAll(":root");zd&&1==zd.length&&zd[0]==H.documentElement&&(yd=!0)}catch(a){}var sd=yd;var Nd={},K=null,Od=Math.random();Nd.C="GTM-MQQMGF";Nd.Ub="8j2";Nd.Nh="";var Pd={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0,__tg:!0},Qd="www.googletagmanager.com/gtm.js";
var Rd=Qd,Sd=null,Td=null,Ud="//www.googletagmanager.com/a?id="+Nd.C+"&cv=21",Vd={},Wd={},Xd=function(){var a=K.sequence||1;K.sequence=a+1;return a};
...
Z.a.awct=["google"],function(){var a=!1,b=[],c=function(k){var l=W("google_trackConversion"),p=k.gtm_onFailure;"function"==typeof l?l(k)||p():p()},d=function(){for(;0<b.length;)c(b.shift())},e=function(){return function(){d();a=!1}},f=function(){return function(){d();b={push:c};}},h=function(k){function l(){
q("gdpr_consent",Gi());}function p(w){var z=!0;z&&b.push(n)}oh();var n={google_basket_transaction_type:"purchase",google_conversion_domain:"",google_conversion_id:k.vtp_conversionId,google_conversion_label:k.vtp_conversionLabel,
google_conversion_value:k.vtp_conversionValue||0,google_remarketing_only:!1,onload_callback:k.vtp_gtmOnSuccess,gtm_onFailure:k.vtp_gtmOnFailure,google_gtm:di()};k.vtp_rdp&&(n.google_restricted_data_processing=!0);void 0!=Jl(E.P)&&!1!==Jl(E.P)&&(n.google_gtm_url_processor=function(w){return w=Rg(w)});var r=function(w){return function(z,x,B){var A="DATA_LAYER"==w?Jl(B):k[x];A&&(n[z]=A)}},t=r("JSON");t("google_conversion_currency","vtp_currencyCode");t("google_conversion_order_id","vtp_orderId");k.vtp_enableProductReporting&&
...
quantity:w.quantity,item_id:w.id}})));var q=function(w,z){void 0!==z&&((n.google_additional_conversion_params=n.google_additional_conversion_params||{})[w]=z)},u=function(w){return function(z,x,B,A){var y="DATA_LAYER"==w?Jl(B):k[x];A(y)&&q(z,y)}};k.vtp_transportUrl&&(n.google_transport_url=k.vtp_transportUrl);var v=Qh(k.vtp_transportUrl,"/pagead/conversion_async.js");v||(v=-1==navigator.userAgent.toLowerCase().indexOf("firefox")?"//www.googleadservices.com/pagead/conversion_async.js":"https://www.google.com/pagead/conversion_async.js");
...
Mf(!1)._up&&q("gtm_up","1");l();(function(){id()?rd(function(){l();var w=pd(E.m),z=!w&&void 0!=Jl(E.P)&&!1!==Jl(E.P);!k.vtp_transportUrl&&z&&(n.google_transport_url="https://pagead2.googlesyndication.com/");q("gcs",qd());p(w);w||ld(function(){l();n=D(n);!k.vtp_transportUrl&&n.google_transport_url&&delete n.google_transport_url;q("gcs",qd());q("gcu","1");p(!0)},E.m)},[E.m]):p(!0)})();a||(a=!0,V(v,f(),e(v)))};
Z.__awct=h;Z.__awct.b="awct";Z.__awct.g=!0;Z.__awct.priorityOverride=0}();




Z.a.hid=["google"],function(){(function(a){Z.__hid=a;Z.__hid.b="hid";Z.__hid.g=!0;Z.__hid.priorityOverride=0})(function(){return Uk.Qb})}();
