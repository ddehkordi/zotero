...
"resource": {
  ...
  "tags":[{
      ...
      "vtp_nonInteraction":false,
      "vtp_overrideGaSettings":false,
      "vtp_eventCategory":"Submit Click",
      "vtp_trackType":"TRACK_EVENT",
      "vtp_gaSettings":["macro",3],
      "vtp_eventAction":"Click",
      "vtp_eventLabel":["macro",0],
      ...
      "function":"__html",
      "once_per_event":true,
      "vtp_html":"\u003Cscript type=\"text\/gtmscript\" data-gtmsrc=\"https:\/\/tracking.magnetmail.net\/MagnetLeads.js\"\u003E\u003C\/script\u003E\u003Cscript type=\"text\/gtmscript\"\u003Ecom.realmagnet.MagnetLeads.init(\"CKDjvYFmlEAKsZByQOafw\");com.realmagnet.MagnetLeads.visitPage();\u003C\/script\u003E",
      ...
      "function":"__html",
      "once_per_event":true,
      "vtp_html":"\n\n\n\u003Cscript type=\"text\/gtmscript\"\u003Evar google_conversion_id=853038534,google_conversion_label=\"OPKMCLqDn3wQxqvhlgM\",google_custom_params=window.google_tag_params,google_remarketing_only=!0;\u003C\/script\u003E\n\u003Cscript type=\"text\/gtmscript\" data-gtmsrc=\"\/\/www.googleadservices.com\/pagead\/conversion.js\"\u003E\u003C\/script\u003E\n\u003Cnoscript\u003E\n\u003Cdiv style=\"display:inline;\"\u003E\n\u003Cimg height=\"1\" width=\"1\" style=\"border-style:none;\" alt=\"\" src=\"\/\/googleads.g.doubleclick.net\/pagead\/viewthroughconversion\/853038534\/?label=OPKMCLqDn3wQxqvhlgM\u0026amp;guid=ON\u0026amp;script=0\"\u003E\n\u003C\/div\u003E\n\u003C\/noscript\u003E",
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":6
  ...
  "predicates":[{
      ...
      "function":"_eq",
      "arg0":["macro",5],
      "arg1":"http:\/\/www.jbc.org\/site\/misc\/itoa.xhtml"
    },{
      "function":"_cn",
      "arg0":["macro",7],
      "arg1":"a[href*=”http:\/\/submit.jbc.org\/”]"
    },{
      "function":"_eq",
      "arg0":["macro",1],
      "arg1":"gtm.click"
  ...
  "rules":[
    [["if",0,1,2],["add",0]],
    [["if",1,4],["unless",3],["add",1]],
    [["if",5],["add",2,4,8,7]],
    [["if",7,8],["add",3]],
    [["if",5,9],["add",5,6]],
    [["if",5,6],["add",9],["block",2]]]
},
"runtime":[]
...
b||Ra(a,b)},D=function(a,b){var c=b||("array"==Qa(a)?[]:{}),d;for(d in a)if(Ra(a,d)){var e=a[d];"array"==Qa(e)?("array"!=Qa(c[d])&&(c[d]=[]),c[d]=D(e,c[d])):Sa(e)?(Sa(c[d])||(c[d]={}),c[d]=D(e,c[d])):c[d]=e}return c};var rb;
...
return null},yd=!1;if(H.querySelectorAll)try{var zd=H.querySelectorAll(":root");zd&&1==zd.length&&zd[0]==H.documentElement&&(yd=!0)}catch(a){}var sd=yd;var Nd={},K=null,Od=Math.random();Nd.C="GTM-PXLKVHK";Nd.Ub="8j2";Nd.Nh="";var Pd={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0,__tg:!0},Qd="www.googletagmanager.com/gtm.js";
var Rd=Qd,Sd=null,Td=null,Ud="//www.googletagmanager.com/a?id="+Nd.C+"&cv=10",Vd={},Wd={},Xd=function(){var a=K.sequence||1;K.sequence=a+1;return a};
...
v("gdpr_consent",Gi());"1"===Mf(!1)._up&&v("gtm_up","1");v("gclid",Ji(b,f));v("gclsrc",h);v("gtm",di(!c));var B=w+"/pagead/landing?"+u.join("&");Wc(B)}}var e=fg(),f=e.gclid||"",h=e.gclsrc,k=e.dclid||"",l=!a&&(!f||h&&"aw.ds"!==h?!1:!0),p=id();if(l||p){var n=""+df();p?rd(function(){d();pd(E.m)||ld(function(){return d(!0)},E.m)},[E.m]):d()}}function Ji(a,b){var c=a&&!pd(E.m);return b&&c?"0":b}var uj=function(){var a=!0;Hi(7)&&Hi(9)&&Hi(10)||(a=!1);var b=!0;b&&!Hi(3)&&(a=!1);return a},vj=function(){var a=!0;Hi(3)||(a=!1);return a};function Pj(){var a=K;return a.gcq=a.gcq||new Qj}
...
var p=Gi();(l.google_additional_params=l.google_additional_params||{}).gdpr_consent=p;f(l)||c()}else c()},e=function(){V(b,d,c)};id()?rd(function(){pd(E.m)?e():ld(e,E.m)},[E.m]):(oh(),e())})}();
...
Z.a.f=["google"],function(){(function(a){Z.__f=a;Z.__f.b="f";Z.__f.g=!0;Z.__f.priorityOverride=0})(function(a){var b=Jl("gtm.referrer",1)||H.referrer;return b?a.vtp_component&&"URL"!=a.vtp_component?Me(Oe(String(b)),a.vtp_component,a.vtp_stripWww,a.vtp_defaultPages,a.vtp_queryKey):Il(String(b)):String(b)})}();
Z.a.cl=["google"],function(){function a(b){var c=b.target;if(c){var d=Xk(c,"gtm.click");Kl(d)}}(function(b){Z.__cl=b;Z.__cl.b="cl";Z.__cl.g=!0;Z.__cl.priorityOverride=0})(function(b){if(!Pl("cl")){var c=W("document");Qc(c,"click",a,!0);Ql("cl")}I(b.vtp_gtmOnSuccess)})}();
...
"");C("require","displayfeatures",void 0,{cookieName:ja})}if("DISPLAY_FEATURES_WITH_REMARKETING_LISTS"==n.vtp_advertisingFeaturesType){var fc="_dc_gtm_"+String(n.vtp_trackingId).replace(/[^A-Za-z0-9-]/g,"");C("require","adfeatures",{cookieName:fc})}Y?C("send","pageview",Y):C("send","pageview");}if(!b){var Cb=
...
Z.a.aev=["google"],function(){function a(q,u){var v=Ee(q,"gtm");if(v)return v[u]}function b(q,u,v,w){w||(w="element");var z=q+"."+u,x;if(n.hasOwnProperty(z))x=n[z];else{var B=a(q,w);if(B&&(x=v(B),n[z]=x,r.push(z),35<r.length)){var A=r.shift();delete n[A]}}return x}function c(q,u,v){var w=a(q,t[u]);return void 0!==w?w:v}function d(q,u){if(!q)return!1;var v=e(Gl());xa(u)||(u=String(u||"").replace(/\s+/g,"").split(","));for(var w=[v],z=0;z<u.length;z++)if(u[z]instanceof RegExp){if(u[z].test(q))return!1}else{var x=
u[z];if(0!=x.length){if(0<=e(q).indexOf(x))return!1;w.push(e(x))}}return!xm(q,w)}function e(q){p.test(q)||(q="http://"+q);return Me(Oe(q),"HOST",!0)}function f(q,u,v){switch(q){case "SUBMIT_TEXT":return b(u,"FORM."+q,h,"formSubmitElement")||v;case "LENGTH":var w=b(u,"FORM."+q,k);return void 0===w?v:w;case "INTERACTED_FIELD_ID":return l(u,"id",v);case "INTERACTED_FIELD_NAME":return l(u,"name",v);case "INTERACTED_FIELD_TYPE":return l(u,"type",v);case "INTERACTED_FIELD_POSITION":var z=a(u,"interactedFormFieldPosition");
return void 0===z?v:z;case "INTERACT_SEQUENCE_NUMBER":var x=a(u,"interactSequenceNumber");return void 0===x?v:x;default:return v}}function h(q){switch(q.tagName.toLowerCase()){case "input":return Sc(q,"value");case "button":return Tc(q);default:return null}}function k(q){if("form"===q.tagName.toLowerCase()&&q.elements){for(var u=0,v=0;v<q.elements.length;v++)dl(q.elements[v])&&u++;return u}}function l(q,u,v){var w=a(q,"interactedFormField");return w&&Sc(w,u)||v}var p=/^https?:\/\//i,n={},r=[],t={ATTRIBUTE:"elementAttribute",
...
v;case "TEXT":return b(u,w,Tc)||v;case "URL":var x;a:{var B=String(a(u,"elementUrl")||v||""),A=Oe(B),y=String(q.vtp_component||"URL");switch(y){case "URL":x=B;break a;case "IS_OUTBOUND":x=d(B,q.vtp_affiliatedDomains);break a;default:x=Me(A,y,q.vtp_stripWww,q.vtp_defaultPages,q.vtp_queryKey)}}return x;case "ATTRIBUTE":var C;if(void 0===q.vtp_attribute)C=c(u,w,v);else{var G=q.vtp_attribute,L=a(u,"element");C=L&&Sc(L,G)||v||""}return C;case "MD":var P=q.vtp_mdValue,U=b(u,"MD",pl);return P&&U?sl(U,P)||
v:U||v;case "FORM":return f(String(q.vtp_component||"SUBMIT_TEXT"),u,v);default:return c(u,w,v)}})}();
Z.a.gas=["google"],function(){(function(a){Z.__gas=a;Z.__gas.b="gas";Z.__gas.g=!0;Z.__gas.priorityOverride=0})(function(a){var b=D(a),c=b;c[Ib.Oa]=null;c[Ib.pf]=null;var d=b=c;d.vtp_fieldsToSet=d.vtp_fieldsToSet||[];var e=d.vtp_cookieDomain;void 0!==e&&(d.vtp_fieldsToSet.push({fieldName:"cookieDomain",value:e}),delete d.vtp_cookieDomain);return b})}();
